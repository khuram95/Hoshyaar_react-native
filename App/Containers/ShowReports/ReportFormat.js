...
class ReportFormat extends Component {
  ...
  _play = async (uri) => {
    let audio = 'http://01c810db.ngrok.io' + uri
          ...
          <View>
            {report.authencity <= 50 ?
              <View style={{ flexDirection: 'row', justifyContent: 'flex-start', }}>
                ...
                <Image source={Images.unlock} style={{ width: 15, height: 15, marginLeft: '2%' }} />
              </View>
              :
              <View style={{ flexDirection: 'row', justifyContent: 'flex-start', }}>
                <Progress.Bar progress={report.authencity / 100} width={200} color="green" height={15} />
                <Image source={Images.lock} style={{ width: 15, height: 15, marginLeft: '2%' }} />
              </View>
            }
          </View>

          <View style={{ marginTop: '5%', marginBottom: '2.5%' }}>
            <ViewMoreText
              numberOfLines={2}
          ...
          <View style={{ flex: 1, flexDirection: "row", marginBottom: '5%', justifyContent: 'flex-start', }}>
            ...
            <View style={styles.video}>
              ...
              <Modal
                ...
                <View>
                  <Video url={'http://01c810db.ngrok.io' + report.video.video.url} />
                  <Button
